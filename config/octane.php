...
return [
    ...
    */
    ...
    'swoole' => [
        ...
        |--------------------------------------------------------------------------
        |
        | HTTP workers run in pool-free coroutine mode. The legacy
        | "swoole.pool" namespace remains only for a startup warning that
        | compares configured DB pool minimums against MySQL max_connections
        | across all Swoole workers.
        |
        */
        'pool' => [
    ...
    */
    ...
    | null to let Octane auto-calculate based on worker count.
    |
    */
