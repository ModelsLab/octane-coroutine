...
class StartSwooleCommandOptionsTest extends TestCase
{
    public function test_swoole_options_include_configured_max_request_grace(): void
    {
        ...
        $this->assertSame(1000, $options['max_request']);
        $this->assertSame(250, $options['max_request_grace']);
        $this->assertSame(250, $options['task_max_request_grace']);
    }

    public function test_swoole_options_default_to_ten_percent_max_request_grace(): void
    {
        ...
        $this->assertSame(10, $options['max_request_grace']);
